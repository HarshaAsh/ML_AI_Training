def caesar_cipher_encrypt(str_to_encrypt, n):
    ...
    alphabet_twice = 'abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyz'
    tuple_alphabet = tuple(alphabet_twice)
    new_str = ''
    for alpha in str_to_encrypt:
        new_str += tuple_alphabet[tuple_alphabet.index(alpha)+n%26]
    return new_str
...
def caesar_cipher_decrypt(str_to_decrypt, n):
    ...
    return caesar_cipher_encrypt(str_to_decrypt, -n)
