...
class Monster(object):
    ...
    def heal(self, healing_points):
        ...
        # YOUR CODE BELOW
        if(self.get_health() + healing_points < self.get_hit_points()):
            self.health += healing_points
            print(self.name + " has " + str(int(self.health)) + " health left.")
        elif(self.health+healing_points >= self.hit_points):
    ...
    def use_attack(self, attack, target_monster):
        ...
        if attack not in self.attacks:
            ...
            print(self.name+ ' hits '+ target_monster.name + ' for '+ str(int(damage))+ '!')
